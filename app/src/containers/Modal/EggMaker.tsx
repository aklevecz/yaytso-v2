...
const eggMakerMap: { [key: number]: ModalProps } = {
  0: { param: "name", cta: "Name your egg", value: "", description: "Give this beautiful egg a fitting name!" },
...
export default function EggMaker() {
  ...
  const done = () => { };
  return <SlideModal propMap={eggMakerMap} updateCallback={updateEgg} values={egg} />;
}
